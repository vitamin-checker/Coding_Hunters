        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="space-y-4">
              <h3 className="text-xl font-bold">Coding Hunters</h3>
              <p className="text-gray-400">Empowering developers to reach their full potential through collaborative learning and coding challenges.</p>
            </div>
            <div className="space-y-4">
          ...
          <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400">
            <p>© {new Date().getFullYear()} Coding Hunters. All rights reserved.</p>
          </div>
        </div>
      </footer>
    )
